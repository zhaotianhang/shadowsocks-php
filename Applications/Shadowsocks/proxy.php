...
$worker->onMessage = function($connection, $buffer_base)use($PROTOCOL, $PROTOCOL_PARAM,$LOCAL_PORT, $SERVER, $PORT)
{
    // 判断当前连接的状态
    switch($connection->stage)
    {
        ...
        case STAGE_ADDR:
            // 先解密数据
            $buffer = $connection->encryptor->decrypt($buffer_base);
            ...
            //$remote_connection = $proxy_connection;
            ...
            {
                $remote_connection->send($buffer_base);
